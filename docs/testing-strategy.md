...
| Mutation tests | `cargo-mutants` (planned with the Verifier) ensures tests catch edge cases |
...
The Verifier (phase 1) adds complexity limits, coverage floors, and mutation
